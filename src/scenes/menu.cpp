...
scene_menu::scene_menu(engine* Engine, game* Game) : Engine(Engine), Game(Game)
{
    ...
    this->Play = new gui_button(this->Engine, this->Game, this->Actor->GetX(), this->Actor->GetY() + 225, 300, 100, "Játék");
    this->Editor = new gui_button(this->Engine, this->Game, this->Actor->GetX(), this->Actor->GetY() + 75, 300, 100, "Pinceditor");
    this->Credits = new gui_button(this->Engine, this->Game, this->Actor->GetX(), this->Actor->GetY() - 75, 300, 100, "Készítők");
    this->Quit = new gui_button(this->Engine, this->Game, this->Actor->GetX(), this->Actor->GetY() - 225, 300, 100, "Kilép");
