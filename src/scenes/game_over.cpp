...
scene_game_over::scene_game_over(engine* Engine, game* Game) : Engine(Engine), Game(Game)
{
    ...
    this->Restart = new gui_button(this->Engine, this->Game, this->Actor->GetX(), this->Actor->GetY() + 75, 0, "Újra");
    this->Menu = new gui_button(this->Engine, this->Game, this->Actor->GetX(), this->Actor->GetY() -75, 0, "Menü");
