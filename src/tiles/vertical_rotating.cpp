...
tile_vertical_rotating::tile_vertical_rotating(engine* Engine, game* Game, double X, double Y) : Engine(Engine), Game(Game)
{
...
uint8 tile_vertical_rotating::Rotate(bool Rotate)
{
    if (Rotate)
    {
