...
tile_top_left_corner::tile_top_left_corner(engine* Engine, game* Game, double X, double Y, uint16 Width, uint16 Height) : Engine(Engine), Game(Game)
{
    ...
    this->HitboxTop = this->Engine->Actors.New(NULL, ACT_NONE, X, Y + Height * 0.3, Width * 0.6, Height * 0.2, 1);
    ...
    this->HitboxBot = this->Engine->Actors.New(NULL, ACT_NONE, X, Y - Height * 0.3, Width * 0.6, Height * 0.2, 1);
    ...
    this->HitboxLeft = this->Engine->Actors.New(NULL, ACT_NONE, X - Width * 0.3, Y, Width * 0.2, Height * 0.6, 1);
    ...
    this->HitboxRight = this->Engine->Actors.New(NULL, ACT_NONE, X + Width * 0.3, Y, Width * 0.2, Height * 0.6, 1);
    ...
    this->HitboxTopLeft = this->Engine->Actors.New(NULL, ACT_NONE, X - Width * 0.3, Y + Height * 0.3, Width * 0.2, Height * 0.2, 1);
    ...
    this->HitboxTopRight = this->Engine->Actors.New(NULL, ACT_NONE, X + Width * 0.3, Y + Height * 0.3, Width * 0.2, Height * 0.2, 1);
    ...
    this->HitboxBotLeft = this->Engine->Actors.New(NULL, ACT_NONE, X - Width * 0.3, Y - Height * 0.3, Width * 0.2, Height * 0.2, 1);
    ...
    this->HitboxBotRight = this->Engine->Actors.New(NULL, ACT_NONE, X + Width * 0.3, Y - Height * 0.3, Width * 0.2, Height * 0.2, 1);
