...
assets::assets(engine* Engine) : Engine(Engine)
{
    ...
    this->HelpBackgroundTexture = this->Engine->Assets.LoadTexture("assets/gui/help_background.png");
    ...
    this->SkyTexture = this->Engine->Assets.LoadTexture("assets/tiles/house/sky.png");
